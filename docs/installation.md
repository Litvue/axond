...
```bash
AXOND_VERSION=0.3.10 AXOND_INSTALL_DIR=/usr/local/bin sh ./install.sh # x-release-please-version
```

```powershell
.\install.ps1 -Version 0.3.10 -InstallDir C:\Tools\axond # x-release-please-version
```
...
```bash
AXOND_VERSION=0.3.10 # x-release-please-version
...
```bash
tag=v0.3.10 # x-release-please-version
version="${tag#v}"
