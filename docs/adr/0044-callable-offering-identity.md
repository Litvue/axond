# 44. Callable offering identity: keying the normalized model projection
...
Extends [ADR 0043](./0043-catalogue-source-imports.md), which settled how a
...
ADR 0043 files an offering under the model it is an offering of — the
...
resolve to one model. Combined with ADR 0043's refusal of ambiguous tails at
...
Tier 0 (config-only), unchanged from ADR 0043. This is an I/O-free projection of
