# 43. Importing a model catalogue: observed rates, snapshot identity, and an offline seed
...
[ADR 0046](./0046-approved-price-books.md) is that statement: an approval
