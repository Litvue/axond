# 35. Callable offering identity: keying the normalized model projection
...
Extends [ADR 0034](./0034-catalogue-source-imports.md), which settled how a
...
ADR 0034 files an offering under the model it is an offering of — the
...
resolve to one model. Combined with ADR 0034's refusal of ambiguous tails at
...
Tier 0 (config-only), unchanged from ADR 0034. This is an I/O-free projection of
