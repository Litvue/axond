# 43. Callable offering identity: keying the normalized model projection
...
Extends [ADR 0042](./0042-catalogue-source-imports.md), which settled how a
...
ADR 0042 files an offering under the model it is an offering of — the
...
resolve to one model. Combined with ADR 0042's refusal of ambiguous tails at
...
Tier 0 (config-only), unchanged from ADR 0042. This is an I/O-free projection of
