# 42. Callable offering identity: keying the normalized model projection
...
Extends [ADR 0041](./0041-catalogue-source-imports.md), which settled how a
...
ADR 0041 files an offering under the model it is an offering of — the
...
resolve to one model. Combined with ADR 0041's refusal of ambiguous tails at
...
Tier 0 (config-only), unchanged from ADR 0041. This is an I/O-free projection of
