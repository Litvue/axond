...
wave 1  (in flight) #252 tenancy/principals/RBAC/audit      #244 empty-ledger adoption
                    ...
                    #276 runtime policy activation          #247 catalogue aliases
                        │
...
| IG-10 | Tenant catalogue views isolated and explained | The tenant-facing catalogue is projected from the snapshot and explains effective availability | IG-03, #255, #247 | `a_tenant_catalogue_is_isolated_and_explains_itself` | blocked |
