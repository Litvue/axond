...
| --- | --- | --- | --- | --- |
| `qualification/capacity/evidence/reduced-local.toml` | reduced | local | `5a81966c9775` | `9c126fd` |
| `qualification/capacity/evidence/heavy-local.toml` | heavy | local | `5a81966c9775` | `9c126fd` |
