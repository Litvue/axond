...
digest="$(ops/pin-image-digest.sh --print 0.3.30)" # x-release-please-version
SIGNER_IDENTITY=... GITHUB_REPOSITORY=Litvue/axond \
  ops/verify-image-evidence.sh "ghcr.io/litvue/axond@${digest}"
ops/pin-image-digest.sh 0.3.30 # x-release-please-version
...
ops/pin-image-digest.sh --print 0.3.30 # x-release-please-version, prints the digest
ops/pin-image-digest.sh 0.3.30 # x-release-please-version, rewrites the overlays
```
