...
digest="$(ops/pin-image-digest.sh --print 0.3.34)" # x-release-please-version
...
ops/pin-image-digest.sh --print 0.3.34 # x-release-please-version, prints the digest
ops/pin-image-digest.sh 0.3.34 # x-release-please-version, rewrites the overlays
```
