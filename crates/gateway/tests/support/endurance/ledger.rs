...
impl Ledger {
    ...
    /// How many fingerprints have been recorded, duplicates included. The
    /// settle wait reads this to know when every dispatched request has been
    /// accounted for without having to tally.
