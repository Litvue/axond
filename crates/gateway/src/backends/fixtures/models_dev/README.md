...
| `catalog.local.json` | Operator-authored one-offering snapshot for a custom vLLM deployment id at a stated `$0` price. Golden bytes for the local catalogue builder. |
