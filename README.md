...
enforced as a narrowing route capability and can be emitted with repeatable
`--scope` flags; `aliases` and `max_request_microdollars` remain unimplemented
(see #61 and #62). An explicit `--audience` must still
